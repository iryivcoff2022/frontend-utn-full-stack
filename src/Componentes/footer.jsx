...
const Footer = () => {
    return (
        <footer classNameName="text-center text-lg-start bg-primary bg-litext-light">
<section className="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
    ...
    <div>
      <a href="https://es-la.facebook.com" classNameName="me-4 text-reset">
      <AiFillFacebook/>
      </a>
      <a href="https://www.instagram.com" classNameName="me-4 text-reset">
      <AiFillInstagram/>
      </a>
      ...
      <BsTwitter/>
        ...
        <section classNameName="">
          <div classNameName="container text-center text-md-start mt-5">

            <div classNameName="row mt-3">

              <div classNameName="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">

                <h6 classNameName="text-uppercase fw-bold mb-4">
                  <i classNameName="fas fa-gem me-3"></i>La Exclusiva
                </h6>
                <p>
                  <a href="Principal.html" classNameName="text-reset">Inicio</a>
                </p>
              </div>
